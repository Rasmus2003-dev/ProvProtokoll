...
export function ProfilScreen() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 py-6 md:py-12 space-y-6 sm:space-y-8 font-sans">
      
      {/* Top action header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 pb-6">
        <div>
          <span className="text-xs font-extrabold uppercase tracking-widest text-primary">Körprovssystem</span>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-display font-black text-gray-950 mt-1 uppercase tracking-tight">Min Profil</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="border border-gray-200 bg-white p-4 sm:p-6 md:p-8 space-y-6">
            ...
            <div className="pt-4 border-t border-gray-100 space-y-3">
              ...
              <button
                ...
                className="w-full mt-2 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-800 font-extrabold text-xs uppercase tracking-widest transition-colors flex items-center justify-center gap-2"
              >
                <Database size={14} />
                Öppna historik ({testHistory.length} prov)
              </button>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-100 pb-4">
              ...
              {!isEditing && (
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2.5 min-h-[40px] bg-gray-950 text-white font-bold text-xs uppercase tracking-wider hover:bg-black uppercase"
                >
                  Modifiera profil
                </button>
              )}
